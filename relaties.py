...
<div style="flex:1;min-width:320px;">
    ...
    <form method="POST" style="margin-bottom:24px;">
        ...
        <button type="submit" style="padding:8px 16px;background:var(--brand-600);color:#fff;border:none;border-radius:6px;font-size:12.5px;font-weight:700;cursor:pointer;">{{ vertaal('Opslaan') }}</button>
    </form>
</div>
